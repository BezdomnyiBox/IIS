...
# 🚀 Инструкция по объединению 2 и 3 практической:

1. Создаем директорию для проекта fullstack приложения
2. Создаем папку frontend и полностью копируем проект из Практической работы №3
3. Создаем папку backend и полностью копируем проект из Практической работы №2
4. Пишем по Dockerfile в каждой папке и docker-compose файл в папке проекта
5. Вместо table и groupData необходимо запросить данные из сервера. Для этого используем хуки useEffect и useState
5a. В useEffect пишем fetch запрос на необходимый ресурс
5b. В useState храним массив полученный из API
